...
_s(HeroSection, "CfsJuyVwRoiH61y9W9UnReQDGSk=");
_c = HeroSection;
...
const fetchFun = ()=>{
    ...
    const useGetTotalStudent = ()=>{
        ...
        const { data, isLoading, isError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
            ...
            queryFn: {
                "fetchFun.useGetTotalStudent.useQuery": async ()=>{
            ...
            }["fetchFun.useGetTotalStudent.useQuery"]
        });
        if (query.isLoading) {
            console.log("loading");
        }
    ...
    _s(useGetTotalStudent, "MSjTYoPrHxtduNXA41YFDDh1ZTg=", false, function() {
        return [
...
//# sourceMappingURL=_00dhdy4._.js.map